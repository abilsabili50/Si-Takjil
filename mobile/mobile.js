...
$(document).ready(function () {
	...
	$(".titleList").on("click", ".listButton", function () {
		...
		$(".main, .main .navbar").css("display", "none");
	...
	$(".detail .back").click(function () {
		$(".main, .main .navbar").css("display", "block");
	...
	$("#print").click(function () {
		...
		const element = document.getElementsByClassName("detail");
		html2pdf()
...
// 	const namaMasjid = localStorage.getItem("namaMasjid");
// 	// const namaMasjidStrip = localStorage.getItem("namaMasjidStrip");
// 	// const section = document.createElement("section");
// 	// const h2 = (document.createElement(
// 	// 	"h2"
// 	// ).textContent = `Data Kontribusi Takjil ${namaMasjidStrip}`);
// 	// const table = document.getElementsByClassName("table");
// 	// const chart = document.getElementsByClassName("chart");
// 	// section.appendChild(h2);
// 	// section.appendChild(table);
// 	// section.appendChild(chart);
// 	const section = document.getElementsByClassName("detail");
// 	html2pdf()
// 		.set({ filename: `${namaMasjid}.pdf` })
// 		.from(section)
// 		.save();
...
function searchTable() {
	...
	for (i = 0; i < tr.length; i++) {
		...
		if (td1 || td2) {
			nama = td1.textContent || td.innerText;
			alamat = td2.textContent || td2.innerText;
			if (
				nama.toUpperCase().indexOf(filter) > -1 ||
				alamat.toUpperCase().indexOf(filter) > -1
			) {
				tr[i].style.display = "";
			} else {
